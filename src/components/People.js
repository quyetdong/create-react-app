...
export default function People() {
  ...
  return (
    <div>
      <Person name={people[0].name} age={people[0].age}>{`${people[0].hobbies ? 'My hobbies are: ' + people[0].hobbies.join(', ') : ''}`}</Person>
      <Person name={people[1].name} age={people[1].age}>{`${people[1].hobbies ? 'My hobbies are: ' + people[1].hobbies.join(', ') : ''}`}</Person>
      <Person name={people[2].name} age={people[2].age}>{`${people[2].hobbies ? 'My hobbies are: ' + people[2].hobbies.join(', ') : ''}`}</Person>
